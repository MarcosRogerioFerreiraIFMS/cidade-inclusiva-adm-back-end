/*
  ...
  - Added the required column `autorId` to the `Comentario` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Comentario" ("acessibilidadeUrbanaId", "atualizadoEm", "conteudo", "criadoEm", "id", "manutencaoId", "motoristaId", "profissionalId", "visivel") SELECT "acessibilidadeUrbanaId", "atualizadoEm", "conteudo", "criadoEm", "id", "manutencaoId", "motoristaId", "profissionalId", "visivel" FROM "Comentario";
